<template>
    <ul class="nav nav-pills flex-column mb-auto">
        <li class="">
            <NuxtLink class="nav-link link-dark" to="/">
        ...
        <li class="">
            <NuxtLink class="nav-link link-dark" to="/users/">
                <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
        ...
        <li class="">
            <NuxtLink class="nav-link link-dark" to="/clients/">
                <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
        ...
        <li class="">
            <NuxtLink class="nav-link link-dark" to="/tickets/">
                <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
        ...
        <li class="">
            <NuxtLink class="nav-link link-dark" to="/system/">
                <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
